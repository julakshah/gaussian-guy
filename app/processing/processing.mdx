...
Given that there are continually updating libraries refining code for Gaussian splatting and making it easier and easier to use, we were quite excited to try it out for our project.
