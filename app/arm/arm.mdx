...
a_star_octree: Holds functions for A* pathfinding to closest unknown section of Octree structure.

octree: Holds custom Octree class for 3D spatial representation as "unknown", "empty", or "occupied."
